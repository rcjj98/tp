...
|  Help  |                                                                                                                      `help`                                                                                                                       |
|  List  |                                                                                                                      `list`                                                                                                                       |
|  Add   | `add [p] n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS [j/JOB_ID]...` :arrow_right: `add [p] n/Bob Tan p/98765876 e/bot@gmail.com a/262 Serangoon Central Drive 1-125 j/1 j/2` `add [i] INDEX d/DATE t/TIME` <br/> `add [p] n/Bob Tan p/98765876 e/bot@gmail.com a/262 Serangoon Central Drive 1-125 j/1 j/2` or `add [i] 1 d/9-May-2020 t/17:30` |
|  Edit  |                                                                                                                      `edit`                                                                                                                       |
|  Find  |                                                                        `find g/[KEYWORDS...]...` :arrow_right: `find g/alex 94825 jobid:1 g/jia ling progress:inprogress`                                                                         |
| Delete |                                        `delete [p] INDEX` :arrow_right: `delete [p] 2` <br/> `delete [p] NAME` :arrow_right: `delete [p] Alex Jones` <br/> `delete [i] INDEX` :arrow_right: `delete [1] 2`                                        |
| Clear  |                                                                                                                      `clear`                                                                                                                      |
|  Exit  |                                                                                                                      `exit`                                                                                                                       |
